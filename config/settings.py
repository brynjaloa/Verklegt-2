...
SECRET_KEY = 'django-insecure-frt*d=ni=@6^j_2q+7uuz&nb0v)(dx=@7&@=&uw!4jz2p@2z69'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.bid_notifications.accepted_bid_notifications',
                'accounts.navigation.previous_page',
            ],
        },
    },
]
...
if os.getenv("DJANGO_USE_SQLITE", "").lower() in {"1", "true", "yes"}:
    DATABASES = {
        "default": {
